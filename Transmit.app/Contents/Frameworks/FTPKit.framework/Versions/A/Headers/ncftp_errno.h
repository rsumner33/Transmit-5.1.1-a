...
/* raw command support -- SPF (ned) */
#if 1
#define kErrCommandFailed			(-207)
#define kErrLast				(207)
#else
#define kErrLast				(206)
#endif
/* end raw command support */

/* TLS support -- SPF (dave) */
#define kErrTLSConnectFailed			(-9999)
#define kErrTLSCouldNotVerifyCert		(-10000)
